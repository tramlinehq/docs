...
The **Timezone** is the timezone that you want to use for your app, within Tramline. This is used to show all the time-related data in Tramline and schedule releases for your app.
