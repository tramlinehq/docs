...
![Cascading Rollout](@assets/img/cascading-rollout-config.png)
...
![](@assets/img/cascading-rollout-99.png)
...
![Cascading Rollout Prompt](@assets/img/cascading-rollout-prompt.png)
